...
export default function SpeakerSec() {
  ...
  const speakers: SpeakerProps[] = [
    {
      ...
      imageSrc: "https://images.unsplash.com/photo-1559839734-2b71ea197ec2?auto=format&fit=crop&q=80&w=400&h=500", // Placeholder
    },
    {
      name: "Dr. Andrew Taylor",
      roles: "Biological Dentist | Mercury-Free Expertise",
      bio: "Bridging Dentistry, Parasitology, Microbiology, and Public Health. Bridging Dentistry, Parasitology, Microbiology, and Public Health.",
      imageSrc: "https://images.unsplash.com/photo-1622253692010-333f2da6031d?auto=format&fit=crop&q=80&w=400&h=500", // Placeholder
    },
    {
      name: "Dr. Blanche Crabe",
      roles: "Biological Dentist | Integrative Medicine",
      bio: "Bridging Dentistry, Parasitology, Microbiology, and Public Health. Bridging Dentistry, Parasitology, Microbiology, and Public Health.",
      imageSrc: "https://images.unsplash.com/photo-1606811841689-23dfddce3e95?auto=format&fit=crop&q=80&w=400&h=500", // Placeholder
    },
    {
      name: "Susan Russle",
  ...
  return (
    <section className="w-full max-w-7xl mx-auto px-6 py-16 lg:py-24 flex flex-col items-center text-center">
      ...
      <div 
        id="speaker-grid"
        className="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 place-items-center"
      >
